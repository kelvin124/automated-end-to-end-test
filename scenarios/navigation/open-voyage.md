...
| 2 | Locate | Locate the voyage quick-search input using its `data-testid` value `vp-voyage-table-quick-search-input`. | The voyage quick-search input is visible. |
...
- **Assertion 1:** The voyage quick-search input identified by `data-testid` value `vp-voyage-table-quick-search-input` is visible.
